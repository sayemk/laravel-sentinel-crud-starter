...
@section('content')
    ...
    <h1>Create New CMS Posts</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/cms','files'=>true, 'class' => 'form-horizontal']) !!}

            <div class="form-group {{ $errors->has('section') ? 'has-error' : ''}}">
                {!! Form::label('section', 'Section: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    {!! Form::select('section', sections(), old('section'), ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('slug') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::text('slug', old('slug'), ['class' => 'form-control', 'required' => 'required','id'=>"slug"]) !!}
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::textarea('description', old('description'), ['class' => 'form-control', 'required' => 'required','id'=>'description']) !!}
